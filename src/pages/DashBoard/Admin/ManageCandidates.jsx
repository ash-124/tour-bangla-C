    ...
    return (
        <div>
            <div className="flex flex-col text-center items-center justify-center">
                ...
                <hr />
                <p className=" italic text-gray-500">Credibly promote backend growth strategies before 24/365 <br /> collaboration and  idea-sharing. Assertively reintermediate cooperative.</p>
            </div>
